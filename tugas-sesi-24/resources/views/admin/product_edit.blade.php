                ...
                <div class="p-6 text-gray-900">
                   ...
                   <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            @if($product->image)
                            <img src="{{ asset('storage/' . $product->image) }}" class="w-24 h-24 object-cover mb-3 rounded border">
                            @endif
                        ...
                        <div class="mb-4">
                            ...
                            <select name="category_id" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                                ...
                                @foreach($categories as $category)
                                    <!-- Trik: Kalau ID kategori sama dengan category_id milik produk, langsung tandai 'selected' -->
