...
<body class="bg-gray-50 text-gray-800">
    ...
    <header class="bg-white shadow-sm py-4">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
            <a href="{{ url('/dashboard') }}" class="text-xl font-extrabold text-indigo-600 hover:text-indigo-800">
                ...
                <div class="p-8 md:w-1/2 flex flex-col justify-center">
                    ...
                    @if(session('success'))
                        <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative mb-4" role="alert">
                            ...
                            <a href="{{ url('/cart') }}" class="underline ml-2">Lihat Keranjang &rarr;</a>
                        </div>
                    @endif
                   ...
                   <form action="{{ route('cart.add', $product->id) }}" method="POST" class="flex flex-col gap-4">
                        ...
                        <button type="submit" class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded w-full mt-4">
                            + Add to Cart
                        </button>
                    </form>
