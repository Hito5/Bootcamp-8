                    ...
                    <table class="w-full text-sm text-left text-gray-500 border">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b">
                                ...
                                <td class="p-3 border text-center">
                                    <a href="{{ route('admin.products.edit', $product->id) }}" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-1 px-3 rounded text-xs mr-2 inline-block">
                                    Edit
                                    </a>
                                    <form action="{{ route('admin.products.destroy', $product->id) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="bg-red-500 hover:bg-red-600 text-white font-bold py-1 px-3 rounded text-xs" onclick="return confirm('Yakin mau hapus produk ini?');">
                                            Delete
                                        </button>
                                    </form>
                                </td>
